...
<body id="application">
    <div class="container">
                ...
                <form id="form" name="form" action="check.asp" method="post" enctype="application/x-www-form-urlencoded" class="tm-form-white tm-font-big" accept-charset="UTF-8"  _charset="UTF-8">
                    <div class="tm-bg-white tm-form-pad-big">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input id="id" name="id" type="text" value="" class="validate" required>
                        </div>
                        <div class="form-group mb-5">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input id="tel" name="tel" type="tel" value="" class="validate" required>
                        </div>
                        <div class="form-group mb-5">
                            <label for="qq" class="black-text mb-4 big">QQ</label>
                            <input id="qq" name="qq" type="text" value="" class="validate" required>
                        </div>
        ...
        <a id="ahover" href="https://www.zstuca.com/">
